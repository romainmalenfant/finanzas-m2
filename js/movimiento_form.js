...
function renderDropdownFacturas(list){
  ...
  dd.innerHTML=list.map(function(f){
    ...
    var monto='<span style="color:#34d399;float:right;">'+fmt(f.monto)+'</span>';
...
function elegirFactura(id){
  ...
  sel.textContent='✓ '+folio+desc+' · '+fmt(f.monto);
